...
var validateFirebaseIdToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var idToken, decodedIdToken, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                functions.logger.error('Error while verifying Firebase ID token:', error_1);
                res.status(403).send('Unauthorized');
                return [2 /*return*/];
